    ...
    <html lang="en">
      ...
      <body>
        <div className="container container_top" >
          <h1>Shopping</h1>
          <div className='serch'>
            <svg viewBox="0 0 512 512" fill="grey" class="header_searchIcon__M4CBh">
            ...
            <div className='cart'>
              <svg viewBox="0 0 512.002 512.002" class="header_cartIcon__286Ri">
          ...
          <div className="hamburger">
            ...
            <div class="select">
                <label for="select"><span>Hello <i class="fas fa-angle-down"></i></span></label>
                <div class="select__inner">
                    <div class="select__item">My Account</div>
                    <div class="select__item">My Order</div>
                    <div class="select__item">Favorites</div>
                    <div class="select__item">Logout</div>
                </div>
            </div>
